        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-home-circle"></i>
                        <span key="t-dashboards">Daftar Penetapan</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?php echo e(route('daftarMajlis')); ?>" key="t-default">Daftar Majlis</a></li>
                        <li><a href="<?php echo e(route('daftarKawasan')); ?>" key="t-saas">Daftar Kawasan</a></li>
                        <li><a href="<?php echo e(route('daftarSeksyen')); ?>" key="t-crypto">Daftar Seksyen</a></li>
                        <li><a href="<?php echo e(route('daftarSubSeksyen')); ?>" key="t-blog">Daftar Sub-Seksyen</a></li>
                        <li><a href="<?php echo e(route('daftarUnitKubur')); ?>"><span key="t-jobs">Daftar Unit Kubur</span></a></li>
                    </ul>
                </li>
...
<!-- Left Sidebar End -->
<?php /**PATH C:\laragon\www\epusara\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>
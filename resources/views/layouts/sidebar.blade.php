        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('daftarMajlis') }}" key="t-default">Daftar Majlis</a></li>
                        <li><a href="{{ route('daftarKawasan') }}" key="t-saas">Daftar Kawasan</a></li>
                        <li><a href="{{ route('daftarSeksyen') }}" key="t-crypto">Daftar Seksyen</a></li>
                        <li><a href="{{ route('daftarSubSeksyen') }}" key="t-blog">Daftar Sub-Seksyen</a></li>
                        <li><a href="{{ route('daftarUnitKubur') }}"><span key="t-jobs">Daftar Unit Kubur</span></a></li>
                    </ul>
                </li>
